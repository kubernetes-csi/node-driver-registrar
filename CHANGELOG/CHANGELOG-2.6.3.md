...
- Fixed CVE-2022-32149. ([#255](https://github.com/kubernetes-csi/node-driver-registrar/pull/255), [@knopt](https://github.com/knopt))
...
- github.com/onsi/ginkgo: [v1.16.4 → v1.14.0](https://github.com/onsi/ginkgo/compare/v1.16.4...v1.14.0)
...
- k8s.io/kubelet: v0.25.2 → v0.25.4
