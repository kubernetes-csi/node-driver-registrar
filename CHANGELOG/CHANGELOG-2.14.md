...
- Add a new `--automaxprocs` flag to set the `GOMAXPROCS` environment variable to match the configured Linux container CPU quota. ([#495](https://github.com/kubernetes-csi/node-driver-registrar/pull/495), [@nixpanic](https://github.com/nixpanic))
- Update kubernetes dependencies to v1.33.0 ([#507](https://github.com/kubernetes-csi/node-driver-registrar/pull/507), [@Aishwarya-Hebbar](https://github.com/Aishwarya-Hebbar))

### Uncategorized

- Fix: CVE-2025-22872 ([#503](https://github.com/kubernetes-csi/node-driver-registrar/pull/503), [@andyzhangx](https://github.com/andyzhangx))
...
- go.opentelemetry.io/otel/metric: v1.33.0 → v1.36.0
