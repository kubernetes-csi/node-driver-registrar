...
- Update Kubernetes dependencies to 1.32.0 ([#471](https://github.com/kubernetes-csi/node-driver-registrar/pull/471), [@dfajmon](https://github.com/dfajmon))
...
- k8s.io/kube-openapi: f0e62f9 → 2c72e55
